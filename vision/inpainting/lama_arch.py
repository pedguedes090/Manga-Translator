...
"""LaMa FFC generator adapted from the Apache-2.0 advimman/lama project.

Only the inference architecture needed by the AnimeMangaInpainting checkpoint is
included here. The upstream source is https://github.com/advimman/lama.
"""
...
def build_lama_model(ckpt_path, device='cpu'):
    """
    Build and load the LaMa model from a .ckpt checkpoint.
    
    Args:
        ckpt_path: Path to the .ckpt file (e.g., lama_large_512px.ckpt)
